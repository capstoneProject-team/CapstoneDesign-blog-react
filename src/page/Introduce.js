    ...
    <div>
      ...
      <br /><br />
        <div data-aos="fade-down" data-aos-duration="1500">
          <Row id="Center" style={{marginTop : "40px"}}>
            <Col id="Center" style={{textAlign : "start", paddingLeft : "100px"}}  span={12}>

              <Title level={1} >오늘 하루 어떠셨나요?<br/></Title>
              <Title level={1} style={{marginTop : "30px"}}>내 이야기를 기록해보세요.<br />오늘 나의 감정을 분석해줍니다 :)</Title>
              <p>HED를 통해 나를 자세히 알아보세요!</p>
              <div style={{marginTop : "70px"}}>
              <Link to="/login"><Button style={{width : "100px", height : "45px"}}id='Button1'>시작하기</Button></Link></div>
            </Col>
            <Col span={12}>
              <Image preview={false} src={introduce_4} style={{height : "500px", width : "500px"}}/>
            </Col>
          </Row>
        ...
        <div data-aos="fade-left" data-aos-duration="2000" data-aos-delay="400">
        <Row id='Center'>
        ...
        <div data-aos="fade-left" data-aos-duration="2000" data-aos-delay="400">
        <Row id='Center'>
          <Col span={12}><Image preview={false} src={introduce_8} id='Small' style={{width : "500px", height : "500px"}}/></Col>
        ...
        <div data-aos="zoom-out" data-aos-duration="2000" data-aos-delay="400">
        <Row id="Center_padding2">
          <Col />
          <Col id="Center"><Title level={1}>Haru Emotion Diary로<br />오직 나에게만 집중해보세요</Title></Col>
          <Col />
        </Row>
